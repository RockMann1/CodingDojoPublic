...
for (let milesRan = 2; milesRan <= 6 ; milesRan +=2 ) {
    //(candyGiven = candyGiven + 1 && console.log(milesRan,candyGiven))  
    candyGiven = candyGiven + 1 
    console.log(milesRan, candyGiven)
}
//for (let candyGiven = 1; milesRan <= 6; candyGiven ++){
